...
var ReactFlagsSelect = function (_a) {
    ...
    var _s = __read(useState(false), 2), isDropdownOpen = _s[0], setIsDropdownOpen = _s[1];
    var _t = __read(useState([]), 2), countriesOptions = _t[0], setCountriesOptions = _t[1];
    var _u = __read(useState([]), 2), filteredCountriesOptions = _u[0], setFilteredCountriesOptions = _u[1];
    var _v = __read(useState(""), 2), filterValue = _v[0], setFilterValue = _v[1];
