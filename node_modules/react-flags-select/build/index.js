...
var ReactFlagsSelect = function (_a) {
    var _b, _c, _d;
    var className = _a.className, selected = _a.selected, onSelect = _a.onSelect, selectButtonClassName = _a.selectButtonClassName, _e = _a.showSelectedLabel, showSelectedLabel = _e === void 0 ? true : _e, _f = _a.showSecondarySelectedLabel, showSecondarySelectedLabel = _f === void 0 ? true : _f, _g = _a.showOptionLabel, showOptionLabel = _g === void 0 ? true : _g, _h = _a.showSecondaryOptionLabel, showSecondaryOptionLabel = _h === void 0 ? true : _h, _j = _a.selectedSize, selectedSize = _j === void 0 ? 16 : _j, _k = _a.optionsSize, optionsSize = _k === void 0 ? 16 : _k, _l = _a.customLabels, customLabels = _l === void 0 ? {} : _l, placeholder = _a.placeholder, _m = _a.searchable, searchable = _m === void 0 ? false : _m, searchPlaceholder = _a.searchPlaceholder, _o = _a.alignOptionsToRight, alignOptionsToRight = _o === void 0 ? false : _o, countries$1 = _a.countries, _p = _a.blacklistCountries, blacklistCountries = _p === void 0 ? false : _p, _q = _a.fullWidth, fullWidth = _q === void 0 ? true : _q, _r = _a.disabled, disabled = _r === void 0 ? false : _r, id = _a.id;
    var _s = __read(React.useState(false), 2), isDropdownOpen = _s[0], setIsDropdownOpen = _s[1];
    var _t = __read(React.useState([]), 2), countriesOptions = _t[0], setCountriesOptions = _t[1];
    var _u = __read(React.useState([]), 2), filteredCountriesOptions = _u[0], setFilteredCountriesOptions = _u[1];
    var _v = __read(React.useState(""), 2), filterValue = _v[0], setFilterValue = _v[1];
    ...
    return (React__default['default'].createElement("div", { className: classnames(styles.flagsSelect, className, (_b = {},
        ...
        React__default['default'].createElement("button", { ref: selectedFlagRef, id: "rfs-btn", type: "button", className: classnames(styles.selectBtn, selectButtonClassName, (_c = {},
            ...
            React__default['default'].createElement("span", { className: styles.selectValue }, validSelectedValue ? (React__default['default'].createElement(React__default['default'].Fragment, null,
                React__default['default'].createElement("span", { className: styles.selectFlag, "data-testid": "rfs-selected-flag" }, getSelectedFlag()),
        ...
        !disabled && isDropdownOpen && (React__default['default'].createElement("ul", { tabIndex: -1, role: "listbox", ref: optionsRef, style: { fontSize: optionsSize }, className: classnames(styles.selectOptions, (_d = {},
            ...
            searchable && (React__default['default'].createElement("div", { className: styles.filterBox },
                React__default['default'].createElement("input", { type: "text", name: "rfs-q", autoComplete: "off", value: filterValue, placeholder: searchPlaceholder || defaultSearchPlaceholder, ref: filterTextRef, onChange: filterSearch }))),
            options.map(function (countryCode) {
                ...
                return (React__default['default'].createElement("li", { key: countryCode, id: "rfs-" + countryCode, role: "option", tabIndex: 0, className: classnames(styles.selectOption, (_a = {},
